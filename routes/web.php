...
Route::prefix('ui')->group(function(){
    ...
    Route::prefix('dashboard')->group(function () {
        Route::view('index', 'ui.dashboard.index')->name('index');
        Route::view('dashboard-02', 'ui.dashboard.dashboard-02')->name('dashboard-02');
    });

    Route::prefix('widgets')->group(function () {
        Route::view('general-widget', 'ui.widgets.general-widget')->name('general-widget');
        Route::view('chart-widget', 'ui.widgets.chart-widget')->name('chart-widget');
    });

    Route::prefix('page-layouts')->group(function () {
        Route::view('box-layout', 'ui.page-layout.box-layout')->name('box-layout');
        Route::view('layout-rtl', 'ui.page-layout.layout-rtl')->name('layout-rtl');
        Route::view('layout-dark', 'ui.page-layout.layout-dark')->name('layout-dark');
        Route::view('hide-on-scroll', 'ui.page-layout.hide-on-scroll')->name('hide-on-scroll');
        Route::view('footer-light', 'ui.page-layout.footer-light')->name('footer-light');
        Route::view('footer-dark', 'ui.page-layout.footer-dark')->name('footer-dark');
        Route::view('footer-fixed', 'ui.page-layout.footer-fixed')->name('footer-fixed');
    });
    ...
    Route::prefix('users')->group(function () {
        Route::view('user-profile', 'ui.apps.user-profile')->name('user-profile');
        Route::view('edit-profile', 'ui.apps.edit-profile')->name('edit-profile');
        Route::view('user-cards', 'ui.apps.user-cards')->name('user-cards');
    });
    ...
    Route::prefix('tables')->group(function () {
        Route::view('bootstrap-basic-table', 'ui.tables.bootstrap-basic-table')->name('bootstrap-basic-table');
        Route::view('bootstrap-sizing-table', 'ui.tables.bootstrap-sizing-table')->name('bootstrap-sizing-table');
        Route::view('bootstrap-border-table', 'ui.tables.bootstrap-border-table')->name('bootstrap-border-table');
        Route::view('bootstrap-styling-table', 'ui.tables.bootstrap-styling-table')->name('bootstrap-styling-table');
        Route::view('table-components', 'ui.tables.table-components')->name('table-components');
        Route::view('datatable-basic-init', 'ui.tables.datatable-basic-init')->name('datatable-basic-init');
        Route::view('datatable-advance', 'ui.tables.datatable-advance')->name('datatable-advance');
        Route::view('datatable-styling', 'ui.tables.datatable-styling')->name('datatable-styling');
        Route::view('datatable-ajax', 'ui.tables.datatable-ajax')->name('datatable-ajax');
        Route::view('datatable-server-side', 'ui.tables.datatable-server-side')->name('datatable-server-side');
        Route::view('datatable-plugin', 'ui.tables.datatable-plugin')->name('datatable-plugin');
        Route::view('datatable-api', 'ui.tables.datatable-api')->name('datatable-api');
        Route::view('datatable-data-source', 'ui.tables.datatable-data-source')->name('datatable-data-source');
        Route::view('datatable-ext-autofill', 'ui.tables.datatable-ext-autofill')->name('datatable-ext-autofill');
        Route::view('datatable-ext-basic-button', 'ui.tables.datatable-ext-basic-button')->name('datatable-ext-basic-button');
        Route::view('datatable-ext-col-reorder', 'ui.tables.datatable-ext-col-reorder')->name('datatable-ext-col-reorder');
        Route::view('datatable-ext-fixed-header', 'ui.tables.datatable-ext-fixed-header')->name('datatable-ext-fixed-header');
        Route::view('datatable-ext-html-5-data-export', 'ui.tables.datatable-ext-html-5-data-export')->name('datatable-ext-html-5-data-export');
        Route::view('datatable-ext-key-table', 'ui.tables.datatable-ext-key-table')->name('datatable-ext-key-table');
        Route::view('datatable-ext-responsive', 'ui.tables.datatable-ext-responsive')->name('datatable-ext-responsive');
        Route::view('datatable-ext-row-reorder', 'ui.tables.datatable-ext-row-reorder')->name('datatable-ext-row-reorder');
        Route::view('datatable-ext-scroller', 'ui.tables.datatable-ext-scroller')->name('datatable-ext-scroller');
        Route::view('jsgrid-table', 'ui.tables.jsgrid-table')->name('jsgrid-table');
    });
